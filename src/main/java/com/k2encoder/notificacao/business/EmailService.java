package com.k2encoder.notificacao.business;

import com.k2encoder.notificacao.business.dto.TarefasDTO;
import com.k2encoder.notificacao.infrastructure.exceptions.EmailException;
    ...
    public void enviaEmail(TarefasDTO dto) {
        try {
            ...
            MimeMessageHelper mimeMessageHelper = new
                    MimeMessageHelper(mensagem, true, StandardCharsets.UTF_8.name());
